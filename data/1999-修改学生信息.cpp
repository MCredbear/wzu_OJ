            ...
            for (j = 0; j < i; j++)
                if (students[j].type == 1)
                    if (students[j].s2 == students[i].s2)
                    {
                        ...
                        // students[j].s3 = students[i].s3;
                        // students[j].s4 = students[i].s4;
                        // students[j].s5 = students[i].s5;
                        // students[j].s6 = students[i].s6;
                        // students[j].s6 = students[i].s6;
                        // students[j].s7 = students[i].s7;
                        // students[j].d1 = students[i].d1;
                        // students[j].d2 = students[i].d2;
                        // students[j].d3 = students[i].d3;
